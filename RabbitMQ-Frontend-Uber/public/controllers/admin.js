...
function adminController($scope, $http, $window) {
    ...
    /* service call for unapproved customers */
    $http({
        method: 'POST',
    ...
    /* service call for unapproved drivers */
    $http({
        method: 'POST',
    ...
    /* service call to review customers */
    $http({
        method: 'POST',
    ...
    /* service call for revenue per day */
    $http({
        method: 'POST',
    ...
    /* service call for rides area-wise - origin */
    $http({
        method: 'POST',
    ...
    /* service call for rides area-wise - dropoff */
    $http({
        method: 'POST',
    ...
    /* service call for rides - driverwise */
    $http({
        method: 'POST',
    ...
    /* service call for ride - customerwise */
    $http({
        method: 'POST',
