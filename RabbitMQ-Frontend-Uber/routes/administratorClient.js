...
function searchbill_by_driverid(req, res) {
    ...
    var msg_payload = {
        ...
        "requestQueue": "searchbill_by_driverid"
    };
    mq_client.make_request('administrator', msg_payload, function(err, results) {
        console.log(results);
        if (results.code == 200) {
...
function searchbill_by_customerid(req, res) {
    var msg_payload = {
        ...
        "requestQueue": "searchbill_by_customerid"
    };
    mq_client.make_request('administrator', msg_payload, function(err, results) {
        console.log(results);
        if (results.code == 200) {
...
function searchbill_by_billid(req, res) {
    var msg_payload = {
        ...
        "requestQueue": "searchbill_by_billid"
    };
    mq_client.make_request('administrator', msg_payload, function(err, results) {
        console.log(results);
        if (results.code == 200) {
...
function searchbill_by_date(req, res) {
    var msg_payload = {
        "rideDate": req.param("rideDate"),
        "requestQueue": "searchbill_by_date"
    };
    mq_client.make_request('administrator', msg_payload, function(err, results) {
        console.log(results);
        if (results.code == 200) {
...
function rides_percustomer(req, res) {
    var msg_payload = {
        "requestQueue": "rides_percustomer"
    };
    mq_client.make_request('administrator', msg_payload, function(err, results) {
        console.log(results);
        if (results.code == 200) {
...
function rides_perpickuplocation(req, res) {
    var msg_payload = {
        "requestQueue": "rides_perpickuplocation"
    };
    mq_client.make_request('administrator', msg_payload, function(err, results) {
        console.log(results);
        if (results.code == 200) {
...
function rides_perdropofflocation(req, res) {
    var msg_payload = {
        "requestQueue": "rides_perdropofflocation"
    };
    mq_client.make_request('administrator', msg_payload, function(err, results) {
        console.log(results);
        if (results.code == 200) {
...
function deletebill_billId(req, res) {
    var msg_payload = {
        "billId": req.param("billId"),
        "requestQueue": "deletebill_billId"
    };
    mq_client.make_request('administrator', msg_payload, function(err, results) {
        console.log(results);
        if (results.code == 200) {
